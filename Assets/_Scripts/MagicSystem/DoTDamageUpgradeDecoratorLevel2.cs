using UnityEngine;
public class DoTDamageUpgradeDecoratorLevel2 : StatUpgradeDecorator
{
    public float Modifier;
    public DoTDamageUpgradeDecoratorLevel2(SpellInstance spellToDecorate, SpellStatUpgradeData spellStatUpgrade, float modifier) : base(spellToDecorate)
    {
        //modifier = Modifier;
