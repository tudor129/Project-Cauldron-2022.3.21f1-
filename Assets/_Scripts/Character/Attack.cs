...
public class Attack : MonoBehaviour
{
    ...
    {
        var particleSystem = ObjectPoolManager.SpawnObject(_attackEffectPrefab, _objectHolder.transform.position, transform.rotation, ObjectPoolManager.PoolType.ParticleSystem);
